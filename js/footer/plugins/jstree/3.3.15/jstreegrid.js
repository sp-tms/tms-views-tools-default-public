            ...
            gs.gridcols.push(i);
				...
				if (!styled) {
					...
					styles = [
						...
						'.jstree-grid-separator {position:absolute; top:0; right:0; height:24px; margin-left: -2px; border-width: 0 1px 0 0; *display:inline; *+display:inline; margin-right:0px;width:0px;}',
